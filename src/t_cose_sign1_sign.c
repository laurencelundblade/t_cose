...
{
    me->content_id_param[0] = t_cose_make_ct_uint_parameter(content_type);
    me->content_id_param[1] = t_cose_make_end_parameter();
...
{
    me->content_id_param[0] = t_cose_make_ct_tstr_parameter(q_useful_buf_from_sz(content_type));
    me->content_id_param[1] = t_cose_make_end_parameter();
