...
#include "t_cose/t_cose_hpke.h"
#include "t_cose/t_cose_aes_kw.h"
                              ...
                              int32_t                              cose_algorithm_id)
{
    ...
    case COSE_ALGORITHM_HPKE_P521_HKDF512_AES256_GCM:
        context->recipient_func = t_cose_create_hpke_recipient;
        break;
    case COSE_ALGORITHM_A256KW:
    case COSE_ALGORITHM_A192KW:
    case COSE_ALGORITHM_A128KW:
        context->recipient_func = t_cose_create_aes_kw_recipient;
        break;
    default:
