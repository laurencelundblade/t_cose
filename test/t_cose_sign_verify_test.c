...
static const uint8_t signed_cose_made_by_ossl_crypto_esp256[] = {
    0xD2, 0x84, 0x43, 0xA1, 0x01, 0x28, 0xA0, 0x47,
    0x70, 0x61, 0x79, 0x6C, 0x6F, 0x61, 0x64, 0x58,
    0x40, 0xBE, 0x25, 0x4A, 0x57, 0x5A, 0x0E, 0x04,
    0x05, 0xC5, 0x78, 0x4C, 0x5E, 0x0B, 0x69, 0xAC,
    0x75, 0xB9, 0x9E, 0x29, 0x0F, 0xFD, 0x5D, 0x09,
    0x0C, 0xDF, 0x61, 0x64, 0x2B, 0x07, 0x79, 0xA3,
    0xEC, 0xE2, 0xAC, 0x46, 0xF4, 0xE6, 0x2B, 0x9C,
    0xAF, 0x07, 0xD7, 0x38, 0xF7, 0xD2, 0x7D, 0xCC,
    0xB7, 0xDB, 0xA0, 0x69, 0x17, 0x4E, 0x10, 0xAE,
    0x41, 0xA5, 0x68, 0x09, 0xFF, 0xFC, 0xFC, 0x97,
    0x41};
...
static const uint8_t signed_cose_made_by_psa_crypto_esp384[] = {
    0xD2, 0x84, 0x44, 0xA1, 0x01, 0x38, 0x32, 0xA0,
    0x47, 0x70, 0x61, 0x79, 0x6C, 0x6F, 0x61, 0x64,
    0x58, 0x60, 0x17, 0x34, 0xFA, 0xE8, 0x32, 0xCC,
    0xB0, 0x44, 0xDB, 0x93, 0x8C, 0xF8, 0xDC, 0xD7,
    0xD8, 0x4D, 0x4F, 0xE0, 0x82, 0x5C, 0xC6, 0x36,
    0x4E, 0x09, 0x1A, 0xA1, 0xC5, 0xA0, 0x54, 0xBA,
    0xE2, 0x97, 0x37, 0xAA, 0x79, 0x73, 0xCB, 0x57,
    0xEB, 0x7B, 0x23, 0x26, 0x40, 0x82, 0xD1, 0x02,
    0xBF, 0xCE, 0x9D, 0x99, 0xC6, 0x36, 0xF4, 0xD9,
    0xB8, 0x3C, 0xE6, 0xED, 0xCC, 0xE3, 0xAE, 0xC9,
    0xCC, 0x2B, 0x9C, 0xDF, 0x19, 0x3F, 0xF6, 0x01,
    0xD7, 0xA9, 0x00, 0x56, 0x02, 0x52, 0xD5, 0x72,
    0x65, 0xDE, 0x00, 0x98, 0x55, 0xA1, 0x3E, 0xDE,
    0xAC, 0xCA, 0xD3, 0x39, 0xA2, 0xCD, 0xB8, 0x93,
    0x9D, 0xBC};
...
static const uint8_t signed_cose_made_by_ossl_crypto_esp512[] = {
    };
...
static struct test_case test_cases[] = {
    ...
    { T_COSE_ALGORITHM_ESP256, { signed_cose_made_by_ossl_crypto_esp256, sizeof(signed_cose_made_by_ossl_crypto_esp256) } },
    { T_COSE_ALGORITHM_ES384, { signed_cose_made_by_psa_crypto_es384, sizeof(signed_cose_made_by_psa_crypto_es384) } },
    { T_COSE_ALGORITHM_ESP384, { signed_cose_made_by_psa_crypto_esp384, sizeof(signed_cose_made_by_psa_crypto_esp384) } },
    { T_COSE_ALGORITHM_ES512, { signed_cose_made_by_ossl_crypto_es512, sizeof(signed_cose_made_by_ossl_crypto_es512) } },
    { T_COSE_ALGORITHM_ESP512, { signed_cose_made_by_ossl_crypto_esp512, sizeof(signed_cose_made_by_ossl_crypto_esp512) } },
...
wrong_key_sign_test(void)
{
    ...
    /* Try to verify an ESP384 sign with an ES512 key and fail */
    t_cose_sign1_verify_init(&verify_ctx, 0);
    t_cose_sign1_set_verification_key(&verify_ctx, key_pair);
