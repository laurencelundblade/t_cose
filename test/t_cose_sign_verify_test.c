...
int_fast32_t sign_verify_basic_test()
{
   ...
   if(return_value) {
    ...
    return_value  = sign_verify_basic_test_alg(T_COSE_ALGORITHM_PS256);
    if(return_value) {
        return 40000 + return_value;
    }
#endif

#ifndef T_COSE_DISABLE_PS384
    return_value  = sign_verify_basic_test_alg(T_COSE_ALGORITHM_PS384);
    if(return_value) {
...
#ifndef T_COSE_DISABLE_PS256
    result = size_test(T_COSE_ALGORITHM_PS256, NULL_Q_USEFUL_BUF_C);
    if(result) {
        return 80000 + result;
    }
...
#ifndef T_COSE_DISABLE_PS384
    result = size_test(T_COSE_ALGORITHM_PS384, NULL_Q_USEFUL_BUF_C);
    if(result) {
        return 90000 + result;
    }
...
#ifndef T_COSE_DISABLE_PS512
    result = size_test(T_COSE_ALGORITHM_PS512, NULL_Q_USEFUL_BUF_C);
    if(result) {
...
#ifndef T_COSE_DISABLE_PS256
    return_value = known_good_test(T_COSE_ALGORITHM_PS256,
                                   Q_USEFUL_BUF_FROM_BYTE_ARRAY_LITERAL(signed_cose_made_by_psa_crypto_ps256));
    if (return_value) {
        return_value = 40000 + return_value;
        goto Done;
    }
#endif /* T_COSE_DISABLE_PS256 */

#ifndef T_COSE_DISABLE_PS384
    return_value = known_good_test(T_COSE_ALGORITHM_PS384,
                                   Q_USEFUL_BUF_FROM_BYTE_ARRAY_LITERAL(signed_cose_made_by_psa_crypto_ps384));
    if (return_value) {
        return_value = 50000 + return_value;
        goto Done;
    }
#endif /* T_COSE_DISABLE_PS384 */

#ifndef T_COSE_DISABLE_PS512
    return_value = known_good_test(T_COSE_ALGORITHM_PS512,
                                   Q_USEFUL_BUF_FROM_BYTE_ARRAY_LITERAL(signed_cose_made_by_psa_crypto_ps512));
    if (return_value) {
        return_value = 60000 + return_value;
        goto Done;
    }
#endif /* T_COSE_DISABLE_PS512 */
