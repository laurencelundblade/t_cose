...
const unsigned char fucec_P_256_priv_key_raw[] = { 0xaf, 0xf9, 0x07, 0xc9, 0x9f, 0x9a, 0xd3, 0xaa, 0xe6, 0xc4, 0xcd, 0xf2,
     0x11, 0x22, 0xbc, 0xe2, 0xbd, 0x68, 0xb5, 0x28, 0x3e, 0x69, 0x07, 0x15,
    0x4a, 0xd9, 0x11, 0x84, 0x0f, 0xa2, 0x00, 0x00};

enum t_cose_err_t
init_fixed_test_ec_encryption_key2(uint32_t           cose_ec_curve_id,
                                  struct t_cose_key *public_key,
                                  struct t_cose_key *private_key)
{
    ...
    case T_COSE_ELLIPTIC_CURVE_P_256:
         type_public  = PSA_KEY_TYPE_ECC_PUBLIC_KEY(PSA_ECC_FAMILY_SECP_R1);
         type_private = PSA_KEY_TYPE_ECC_KEY_PAIR(PSA_ECC_FAMILY_SECP_R1);
         key_bytes    = Q_USEFUL_BUF_FROM_BYTE_ARRAY_LITERAL(fucec_P_256_priv_key_raw);
         key_bitlen   = 256;
         break;
    case T_COSE_ELLIPTIC_CURVE_P_384:
         type_public  = PSA_KEY_TYPE_ECC_PUBLIC_KEY(PSA_ECC_FAMILY_SECP_R1);
