...
/* I don't know how thes were generated. Pretty sure they
 * are related and were generated at the same time (or they
 * wouldn't work).
 *
 * Would also like to know exactly what the format is here.
 * Obviously not DER, but what about x9? 
 */
